...
RSpec.describe ContractTypesController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new contract_type as @contract_type" do
      ...
      expect(assigns(:contract_type)).to be_a_new(ContractType)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created contract_type as @contract_type" do
        post :create, {:contract_type => valid_attributes}, valid_session
        expect(assigns(:contract_type)).to be_a(ContractType)
        expect(assigns(:contract_type)).to be_persisted
      end

      it "redirects to the created contract_type" do
        post :create, {:contract_type => valid_attributes}, valid_session
        expect(response).to redirect_to(ContractType.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved contract_type as @contract_type" do
        post :create, {:contract_type => invalid_attributes}, valid_session
        expect(assigns(:contract_type)).to be_a_new(ContractType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the contract_type" do
        contract_type = ContractType.create! valid_attributes
        put :update, {:id => contract_type.to_param, :contract_type => valid_attributes}, valid_session
        expect(response).to redirect_to(contract_type)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the contract_type as @contract_type" do
        contract_type = ContractType.create! valid_attributes
        put :update, {:id => contract_type.to_param, :contract_type => invalid_attributes}, valid_session
        expect(assigns(:contract_type)).to eq(contract_type)
      end
